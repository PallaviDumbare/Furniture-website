...
function Interior() {
  return (
    <div className='mb-5'>
        ...
        <Row className='text-start bg-light mb-5 g-5 py-5'>
            ...
            <div className='position-relative'>
                ...
                <div className='position-absolute top-50 start-50 translate-middle-x'>
                    ...
                    <img src='./images/img-grid-3.jpg' alt='' height={320} width={280} className='rounded rounded-4'style={{marginTop:"235px", marginLeft:"200px"}}/>
                    </div>
                </div>
            </div>
            </Col>
        ...
        <div className="row row-cols-1 row-cols-md-3 g-4 mt-5 bg-light">
           <div className="col">
